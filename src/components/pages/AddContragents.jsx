...
import { addCard } from '../../store/contragentsSlice';
    ...
    <div className="container-addCard">
      ...
      <form onSubmit={handleSubmit(formSubmit, errorsHandler)}>
        <div>
          ...
          <p>Прізвище нового контрагента:</p>
          <input
            type="text"
            className="formInput"
          ...
          <p>
            Введіть номер карти контрагента (номер повинен бути довжиною 16 та
